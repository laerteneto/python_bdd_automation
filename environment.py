...
def BrowserSetUp(context):
    ...
    if context.config.userdata['browser'] == 'firefox':
        ...
        options.add_experimental_option("prefs", {
            "download.default_directory": "C:\\Users\\malencar\\Documents\\Projetos\\everis-python-bdd-automation\\temp",
...
def GenerateEvidence(context, scenario):
    ...
    pytest.time_start_format = "Test_Suit_Executed_At_" + \
        pytest.time_start.strftime("%d_%m_%Y_%H_%M_%S")
    yield
